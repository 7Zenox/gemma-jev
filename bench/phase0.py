...
mean family balanced accuracy, so a Gemma number can be placed on the same scale
...
Usage:
    python bench/phase0.py --model google/gemma-3-1b-pt \
        --input reference/openjev/benchmarks/data/authored144.jsonl \
        --output results/local/phase0-gemma3-1b-pt.json
"""
...
from gemma_jev.core import load_causal_model, validate_row  # noqa: E402
from gemma_jev.direct import score  # noqa: E402
from gemma_jev.metrics import summarize  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--dtype", default="auto", help="auto (bf16 on GPU, fp32 on CPU), bfloat16 or float32")
    parser.add_argument("--input", type=Path, required=True)
    parser.add_argument("--output", type=Path, required=True)
    parser.add_argument("--style", choices=("completion", "chat", "chat-json"), default="completion")
