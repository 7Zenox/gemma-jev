...
Usage:
    python bench/shared_check.py --model google/gemma-3-1b-pt \
...
from gemma_jev.core import load_causal_model, render_state, validate_row  # noqa: E402
...
def main() -> None:
    ...
    report = {
        "schema": "gemma-jev-shared-check-v1",
        "model": metadata,
