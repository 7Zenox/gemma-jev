"""FastAPI server for the gemma-jev demonstration UI.
...
from gemma_jev.core import LETTERS, load_causal_model  # noqa: E402
from gemma_jev.direct import score as direct_score  # noqa: E402
from gemma_jev.generate import stream_json_generation  # noqa: E402
from gemma_jev.shared import score_shared  # noqa: E402

MODEL_ID = os.environ.get("GEMMA_JEV_MODEL", "google/gemma-3-1b-pt")
PROMPT_STYLE = os.environ.get("GEMMA_JEV_STYLE", "completion")
SHOTS = int(os.environ.get("GEMMA_JEV_SHOTS", "3"))
...
app = FastAPI(title="gemma-jev", lifespan=lifespan)
